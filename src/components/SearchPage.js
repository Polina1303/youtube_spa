                        ...
                        ? <div className="list_or_grid">
                            ...
                            <div>
                                <div className="listgrid">
                                    <button className='search__heart' onClick={() => setSort('list')}><BarsOutlined style={{ fontSize: '25px' }} /></button>
                                    <button className='search__heart' onClick={() => setSort('grid')}><AppstoreOutlined style={{ fontSize: '25px' }} /></button>
                                </div>
                            </div>
                        </div>
                        : null
